...
import com.example.paul.betprofessor.ui.helpers.ResultAdapter;
...
public class ResultActivity extends AppCompatActivity {
    ...
    private void onSetValues(){
        ...
        viewModel.getGetLastTwentyResults().observe(this, new Observer<List<OneResult>>() {
            @Override
